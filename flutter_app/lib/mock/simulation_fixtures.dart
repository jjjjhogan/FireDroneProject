...
const mockScenarios = [
  ...
  Scenario(
    scenarioId: 'sonoran-dust-front',
    title: 'Sonoran Dust Front',
    region: 'Desert',
    description:
        'Monsoon outflow patrol across arroyo networks with heat-shimmer distortion.',
    difficulty: ScenarioDifficulty.advanced,
    simulatedDroneCount: 5,
    simulatedAlertCount: 2,
    tags: ['heat', 'dust', 'monsoon'],
    color: Color(0xffb45309),
    seed: 20,
    image: 'assets/images/mission-map-fallback.png',
  ),
  Scenario(
    scenarioId: 'plains-wind-run',
    title: 'Great Plains Wind Run',
    region: 'Grassland',
    description:
        'Fast grass-fire racetrack with fence-line spotting and open-range relay legs.',
    difficulty: ScenarioDifficulty.intermediate,
    simulatedDroneCount: 4,
    simulatedAlertCount: 2,
    tags: ['grass', 'rate-of-spread', 'open range'],
    color: Color(0xff4d7c0f),
    seed: 24,
    image: 'assets/images/mission-map-fallback.png',
  ),
  Scenario(
    scenarioId: 'sierra-foothills-wui',
    title: 'Sierra Foothills WUI',
    region: 'Urban-Wildland',
    description:
        'Structure-protection corridor with evacuation routes and congested airspace.',
    difficulty: ScenarioDifficulty.extreme,
    simulatedDroneCount: 8,
    simulatedAlertCount: 5,
    tags: ['WUI', 'structures', 'airspace'],
    color: Color(0xff475569),
    seed: 28,
    image: 'assets/images/mission-map-fallback.png',
  ),
  Scenario(
    scenarioId: 'gulf-coast-fuel-belt',
    title: 'Gulf Coast Fuel Belt',
    region: 'Subtropical',
    description:
        'Humid palmetto understory sweep after tropical storm outflow.',
    difficulty: ScenarioDifficulty.advanced,
    simulatedDroneCount: 6,
    simulatedAlertCount: 4,
    tags: ['humidity', 'storm', 'canopy'],
    color: Color(0xff0369a1),
    seed: 32,
    image: 'assets/images/mission-map-fallback.png',
  ),
  Scenario(
    scenarioId: 'cascade-high-country',
    title: 'Cascade High Country',
    region: 'Alpine',
    description:
        'Snow-line transition patrol with thin-air margins and talus obstacle fields.',
    difficulty: ScenarioDifficulty.advanced,
    simulatedDroneCount: 5,
    simulatedAlertCount: 2,
    tags: ['elevation', 'snow line', 'talus'],
    color: Color(0xff0f766e),
    seed: 36,
    image: 'assets/images/mission-map-fallback.png',
  ),
  Scenario(
    scenarioId: 'everglades-peat-margin',
    title: 'Everglades Peat Margin',
    region: 'Wetland',
    description:
        'Peat-smolder detection along mangrove edges with pooled low-level smoke.',
    difficulty: ScenarioDifficulty.intermediate,
    simulatedDroneCount: 4,
    simulatedAlertCount: 3,
    tags: ['peat', 'smolder', 'mangrove'],
